<div class="fly-header layui-bg-black">
    <div class="layui-container">
        <a class="fly-logo" href="/">
            <img src="/res/images/logo.png" width="168" height="47" alt="layui" style="margin-top: -4px;">
        </a>
                ...
                <li class="layui-nav-item">
                    <a class="fly-nav-avatar" href="javascript:void(0);">
                        ...
                        <@shiro.hasRole name="admin" >
                            ...
                            <i class="layui-badge fly-badge-vip layui-hide-xs">VIP9</i>
                        </@shiro.hasRole>
                        <img src="<@shiro.principal property="avatar" />" alt="<@shiro.principal property="username" />">
                    </a>
